...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = PROGNAME
...
static const string mainnet_seeds[] = MAINNET_SEEDS;
static const string testnet_seeds[] = TESTNET_SEEDS;
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", MAINNET), true);
  }
  do {
...
int main(int argc, char **argv) {
  ...
  if (opts.fUseTestNet) {
      ...
      pchMessageStart[0] = TESTNET_MAGIC0;
      pchMessageStart[1] = TESTNET_MAGIC1;
      pchMessageStart[2] = TESTNET_MAGIC2;
      pchMessageStart[3] = TESTNET_MAGIC3;
      seeds = testnet_seeds;
      fTestNet = true;
  }
  if (!opts.ns) {
